...
public class FieldOfView {
	 ...
	 * @param world the world
	 */
	private void loopFor(World world) {
	 ...
	 * @param x the x
	 */
	private void loopFor2(int wx, int wy, int wz, int r, int x) {
		for (int y = -r; y < r; y++){
			if (x*x + y*y > r*r)
				continue;
	 ...
	 * @param y the y
	 */
	private void loopFor1(int wx, int wy, int wz, int x, int y) {
